...
O menu **Documentos › Links** é um **repositório de URLs úteis** (título, URL, descrição, categoria). É um *bookmark manager* interno, **não** um gerador de "share-links de formulários" com token único, expiração, uso único e vinculação a destinatário.
