...
export const getPanelDados = createServerFn({ method: "POST" })
  ...
  .handler(async ({ data, context }): Promise<any> => {
    try {
      ...
      console.log("[getPanelDados] Request data:", JSON.stringify(data));
      console.log("[getPanelDados] Intervalo:", { de, ate });
    ...
    // Pre-carrega parceiros para evitar recursão ou falha de contexto
