 ...
 *
 * O vendedor NÃO recebe padrões como o comprador: os dados dele são de outra
 * pessoa e precisam ser preenchidos de verdade. Faltando algum, ele não vai à
 * integração — o operador é avisado na hora e fica o registro no histórico.
 */
...
export function payloadParticipanteVendedor(
  ...
  const payload: Record<string, unknown> = {
    ...
    // Sem RG no cadastro, pessoa física vai com o próprio CPF.
    numeroDocumento:
