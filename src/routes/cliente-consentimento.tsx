    ...
    <div className="flex min-h-dvh flex-col bg-background text-foreground">
      ...
      <main className="mx-auto w-full max-w-2xl flex-1 px-4 py-6">
        <p className="text-sm text-muted-foreground">
          Para acessar o App do Cliente pela primeira vez, precisamos do seu
          consentimento quanto ao tratamento dos seus dados pessoais, conforme a
        ...
        <div className="mt-4 max-h-[46vh] space-y-4 overflow-y-auto rounded-lg border border-border bg-card p-4 text-sm leading-relaxed text-card-foreground">
          <div>
            ...
            <p className="text-muted-foreground">
              Coletamos e tratamos dados cadastrais, de contato, documentos e
              informações necessárias à análise e ao acompanhamento do seu
              processo de financiamento imobiliário e crédito.
            </p>
          </div>
          <div>
            <h2 className="font-semibold">2. Finalidade</h2>
            <p className="text-muted-foreground">
              Seus dados são utilizados exclusivamente para viabilizar a
              simulação, a originação e o acompanhamento da sua proposta junto às
              instituições financeiras parceiras, além de comunicações sobre o
          ...
          <div>
            ...
            <p className="text-muted-foreground">
              As informações poderão ser compartilhadas com instituições
              financeiras e prestadores estritamente necessários à conclusão do
              seu processo, sempre respeitando a confidencialidade e a segurança
              dos dados.
            </p>
          </div>
          <div>
            ...
            <p className="text-muted-foreground">
              ...
              portabilidade ou exclusão dos seus dados diretamente pelo App, na
              área "Privacidade e meus dados (LGPD)".
            </p>
          </div>
          <div>
            <h2 className="font-semibold">5. Armazenamento</h2>
            <p className="text-muted-foreground">
              Seus dados são armazenados de forma segura pelo período necessário
              ao cumprimento das finalidades acima e das obrigações legais
              aplicáveis.
            </p>
          </div>
        </div>
        ...
        <label className="mt-5 flex cursor-pointer items-start gap-3 rounded-lg border border-border bg-card p-4">
          ...
          <span className="text-sm text-card-foreground">
            Li e concordo com o Termo de Consentimento e autorizo o tratamento
            dos meus dados pessoais conforme descrito acima.
          </span>
        </label>
        ...
        <p className="mt-3 text-center text-xs text-muted-foreground">
          O seu aceite será registrado com data, hora e IP para fins de
          conformidade.
        </p>
      </main>
    </div>
