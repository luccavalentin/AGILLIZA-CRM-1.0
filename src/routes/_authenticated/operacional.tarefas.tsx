                  ...
                  {g.tarefas.map((t) => {
                    ...
                    return (
                      <li key={t.id}>
                        <div
                          className={cn(
                            "op-row group flex items-center gap-3 rounded-2xl border border-border/70 bg-card p-3 pr-3 shadow-card transition-all hover:-translate-y-0.5 hover:shadow-elevated md:gap-4 md:p-3.5",
