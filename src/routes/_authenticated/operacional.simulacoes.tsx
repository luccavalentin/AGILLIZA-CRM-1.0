...
function Pagina() {
  ...
  // Simulação em "enviando" quer dizer banco assíncrono (Santander) ainda sem
  // resposta. Enquanto houver alguma na lista, pedimos a reconciliação — antes
  // ela só era disparada no envio, e a linha ficava em "Em análise" para
  // sempre mesmo com a parcela já pronta na HomeFin.
  ...
  return (
    <div className="mx-auto w-full max-w-[1600px] space-y-2 p-1.5 md:p-3">
      ...
      {/* Paginação */}
      {!isLoading && data && data.total > porPagina && (
        <div className="flex items-center justify-center gap-2 py-4">
          ...
          <Button
            ...
            disabled={pagina >= Math.ceil(data.total / porPagina)}
          >
            Próxima
          </Button>
        </div>
