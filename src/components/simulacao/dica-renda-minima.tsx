    ...
    return (
      <div className="flex flex-col gap-2">
        ...
        <div className="flex flex-col gap-1.5 px-1 mt-1">
          ...
          <button
            type="button"
            onClick={() => props.onApply?.(evalSac.rendaMinima, evalPrice.rendaMinima)}
            className="text-[10px] font-semibold text-primary hover:underline flex items-center gap-1 w-fit transition-all hover:gap-1.5"
          >
            <CheckCircle2 className="h-3 w-3" />
            Ajustar automaticamente os campos de renda para a renda mínima estimada
          </button>
        </div>
      </div>
    );
  ...
  return (
    <div className="flex flex-col gap-1">
      ...
      <div className="flex flex-col gap-1.5 px-1 mt-1">
        ...
        <button
          type="button"
          onClick={() => props.onApply?.(sistema === "S" ? rendaMin : undefined, sistema === "P" ? rendaMin : undefined)}
          className="text-[10px] font-semibold text-primary hover:underline flex items-center gap-1 w-fit transition-all hover:gap-1.5"
        >
          <CheckCircle2 className="h-3 w-3" />
          Ajustar automaticamente os campos de renda para a renda mínima estimada
