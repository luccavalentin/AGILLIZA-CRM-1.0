import { Check, Landmark, Download } from "lucide-react";
...
export function SecaoBancos({ ctx }: { ctx: SimulacaoCompletaCtx }) {
  ...
  if (modoAmbos) {
    ...
    return (
      <section className="space-y-6">
        ...
        <div className="mt-6 flex items-center gap-3 rounded-xl border border-primary/10 bg-primary/5 p-4 shadow-sm transition-all hover:bg-primary/10">
          <div className="flex h-10 w-10 shrink-0 items-center justify-center rounded-lg bg-primary/10 text-primary">
            <Download className="h-5 w-5" />
          </div>
          <div className="flex-1 space-y-0.5">
            <Label
              htmlFor="download-automatico-ambos"
              className="cursor-pointer text-sm font-semibold text-foreground"
            >
              Baixar PDF automaticamente
            </Label>
            <p className="text-xs text-muted-foreground">
              Ao finalizar a simulação, o PDF detalhado será baixado para o seu dispositivo.
            </p>
          </div>
          <Switch
  ...
  return (
    <section className="space-y-4">
      ...
      <div className="mt-8 flex items-center gap-3 rounded-xl border border-primary/10 bg-primary/5 p-4 shadow-sm transition-all hover:bg-primary/10">
        <div className="flex h-10 w-10 shrink-0 items-center justify-center rounded-lg bg-primary/10 text-primary">
          <Download className="h-5 w-5" />
        </div>
        <div className="flex-1 space-y-0.5">
          <Label
            htmlFor="download-automatico"
            className="cursor-pointer text-sm font-semibold text-foreground"
          >
            Baixar PDF automaticamente
          </Label>
