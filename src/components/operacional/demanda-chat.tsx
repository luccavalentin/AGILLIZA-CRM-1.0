...
export function DemandaChatConversa({
  ...
  const titulo = demanda?.titulo ?? info?.titulo ?? "Conversa da demanda";
      ...
      <div className="grid grid-cols-[auto_minmax(0,1fr)_auto] items-center gap-2 border-b bg-card px-3 py-2.5 sm:gap-3 sm:px-4 sm:py-3">
        ...
        <div className="min-w-0 flex-1">
          ...
          <div className="flex min-w-0 items-center gap-2 overflow-hidden">
            <span className="h-5 rounded-full bg-secondary px-2 py-0.5 text-[10px] font-medium text-secondary-foreground">
              {numero}
            </span>
